        ...
        <section class="cabecera-biblioteca">
            <div>
                ...
                <p class="texto-cabecera">
                    <?= $modoEdicion ? 'Actualiza tu seguimiento de este juego y ajusta los datos de tu biblioteca.' : 'Guarda el estado de este juego en tu biblioteca y deja preparado tu seguimiento.' ?>
                </p>
            </div>
