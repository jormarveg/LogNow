...
En la parte de cliente, he practicado el uso de JavaScript para mejorar la interacción de la aplicación sin depender siempre de recargas completas. Algunos ejemplos son la búsqueda dinámica, los filtros, el selector de puntuación con estrellas, las validaciones de formularios y determinadas acciones mediante AJAX.
